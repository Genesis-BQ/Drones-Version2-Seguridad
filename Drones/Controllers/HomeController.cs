...
namespace Drones.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            HomeController preguntasController = new HomeController();
            List<PreguntaSeguridad> preguntasSeguridad = preguntasController.ObtenerPreguntasSeguridad();
        ...
        [HttpPost]
        public ActionResult CargarDatos(Usuario usuario)
        {
            try
            {
